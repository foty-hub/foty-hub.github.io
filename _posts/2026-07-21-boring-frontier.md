...
A deeper, related idea from neuroscience is 'predictive processing', which proposes that our perception of the world is just our brain's prediction of what it *ought to perceive*. That idea backs up the world models direction, but it's interesting for many reasons beyond robotics; check out [The Experience Machine](https://uk.bookshop.org/p/books/the-experience-machine-how-our-minds-predict-and-shape-reality-andy-clark/e07a087f415446a4) by Andy Clark for a very digestible introduction!
