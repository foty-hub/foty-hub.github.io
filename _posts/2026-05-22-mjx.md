...
I'm currently working on a basic world model, which means I need to collect a bunch of simulation data to train it. In this post I'll show how JAX, via its MuJoCo backend MJX, gives us a neat way to do that data collection quickly. Doing beats reading, so I'd recommend writing out the code yourself and playing around with it to see where things break. There's also a companion [Google Colab](https://colab.research.google.com/drive/1Q85OieLsHMV98rg7mrbk3A6lKc8qEAtQ?usp=sharing) you can run to try things for yourself.
